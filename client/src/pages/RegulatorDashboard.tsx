...
export default function RegulatorDashboard() {
  ...
  const [processingAdminId, setProcessingAdminId] =
  ...
  async function fetchAdmins() {
    try {
      ...
      const response = await fetch(
        "https://indian-wholesalers-api.onrender.com/api/admins",
        {
          method: "GET",
          credentials: "include",
        }
  ...
  async function handleToggleAdmin(
    ...
    try {
      const response = await fetch(
        `https://indian-wholesalers-api.onrender.com/api/admins/${admin.id}/${action}`,
        {
          method: "PATCH",
          credentials: "include",
        }
      ...
      if (action === "block") {
        setMessage(
          "Admin account blocked successfully."
        );
      } else {
        setMessage(
          "Admin account unblocked successfully."
        );
      }
                ...
                <div className="form-group">
                  ...
                  <div className="input-field-wrapper">
                    ...
                    <input
                      ...
                      placeholder="rajesh@wholesalers.in"
                      required
                    />
